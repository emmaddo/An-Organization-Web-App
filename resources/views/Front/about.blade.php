				...
				<div class="item-list">
					<div class="row">
						...
						<div class="col-md-7 col-sm-12 col-xs-12">
			                <div class="sec-title">
								<h2 class="left">About ATWAP</h2>
								<p>Association of Table Water Processors of Ondo State (ATWAP) is a non-governmental organisation set forth to promote health and environmental hygiene Table Water processing and consumption for the good people of Ondo State.</p>
