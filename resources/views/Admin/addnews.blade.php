    ...
    <div class="card">
      <div class="card-body">
        ...
        @if(Session::get('success'))
          ...
          @endif
        <form class="forms-sample" method="POST" action="/postaddnews" enctype="multipart/form-data">
        @csrf   
        <div class="form-group">
            <label for="exampleInputName1">News Title</label>
            <input type="text" name="title" class="form-control" id="exampleInputName1" placeholder="Enter News Title" required>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail3">News Intro</label>
            <input type="text" name="intro" class="form-control" id="exampleInputEmail3" placeholder="Enter News Intro" required>
          </div>
         ...
         <!-- <div class="form-group">
          ...
          <button type="submit" class="btn btn-primary mr-2">Submit News</button>
