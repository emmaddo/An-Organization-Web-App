...
@endif
  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Email Broadcast</h4>
          ...
          <p>Send Email Broacast to all Members</p>
        </p>
        <form class="forms-sample" method="POST" action="{{url('postemailbroadcast')}}" enctype="multipart/form-data">
        @csrf   
        <div class="form-group">
            <label for="exampleInputName1">Email Subject</label>
            <input type="text" name="subject" class="form-control" id="exampleInputName1" placeholder="Enter Memo Topic" required>
          </div>
          
          
          
          <div class="form-group">
            <label for="exampleTextarea1">Email Content</label>
            <textarea name="content" class="form-control" id="exampleTextarea1" rows="4" required></textarea>
          </div>
         ...
         <!-- <div class="form-group">
          ...
          <button type="submit" class="btn btn-primary mr-2">Send Email Broadcast</button>
