...
@endif
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
  <div class="card-body">
    <h4 class="card-title">Available Memos</h4>
            ...
            <table id="order-listing" class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{url('Admin/MemoDetails/'.$post->id)}}" class="btn btn-outline-primary">View</a>
                  </td>
				   <td><a class="pe-2" href="{{url('Admin/EditMemo/'.$post->id)}}"> <i class="mdi mdi-table-edit"></i></a> <a href="{{url('Admin/DeleteMemo/'.$post->id)}}" onclick="return confirm('Are you sure you want to delete this Memo?')"> <i class="mdi mdi-delete"></i></a></td>
                </tr>
                @endforeach
