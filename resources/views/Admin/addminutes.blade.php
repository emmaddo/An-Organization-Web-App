...
@endif
  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Add Minutes</h4>
        ...
        @if(Session::get('success'))
          ...
          @endif
        <form class="forms-sample" method="POST" action="/postaddminutes" enctype="multipart/form-data">
        @csrf   
        <div class="form-group">
            <label for="exampleInputName1">Minutes Topic</label>
            <input type="text" name="topic" class="form-control" id="exampleInputName1" placeholder="Enter Minutes Topic" required>
          </div>
         ...
         <!-- <div class="form-group">
          ...
          <button type="submit" class="btn btn-primary mr-2">Submit Minutes</button>
