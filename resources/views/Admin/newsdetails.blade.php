  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
       ...
       <center>
       <img src="{{ url('../storage/front/images/news/'.$viewnews->image_name) }}" width="200px" alt="News" />
            
       </center>

        <div class="form-group">
            <label for="exampleInputName1">News Title</label>
            <input type="text" name="title" value="{{$viewnews->title}}" class="form-control" id="exampleInputName1" readonly>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail3">News Intro</label>
            <input type="text" name="intro" value="{{$viewnews->intro}}" class="form-control" id="exampleInputEmail3" readonly>
          </div>
          
          
          <div class="form-group">
            <label for="exampleTextarea1">News Content</label>
            <textarea name="content" class="form-control" id="exampleTextarea1" rows="4" readonly>{{$viewnews->content}}</textarea>
          </div>
         ...
         <!-- <div class="form-group">
          ...
          <a href="{{url('Admin/EditNews/'.$viewnews->id)}}"  class="btn btn-primary mr-2">Edit News</a>
