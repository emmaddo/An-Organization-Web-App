...
@endif
  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Edit Minutes</h4>
        ...
        @if(Session::get('success'))
          ...
          <center>
       <img src="{{ url('../storage/front/images/minutes/'.$editminutes->image_name) }}" width="200px" alt="No Image for this Minutes" />
            
       </center>
      

        <form class="forms-sample" method="POST" action="{{url('posteditminutes/'.$editminutes->id)}}" enctype="multipart/form-data">
        @csrf   
        <div class="form-group">
            <label for="exampleInputName1">Minutes Topic</label>
            <input type="text" name="topic" value="{{$editminutes->topic}}" class="form-control" id="exampleInputName1" placeholder="Enter Minutes Topic">
          </div>
         
          <div class="form-group">
            <label for="exampleTextarea1">Minutes Content</label>
            <textarea name="content" class="form-control" id="exampleTextarea1" rows="4">{{$editminutes->content}}</textarea>
          </div>
                      
          <div class="form-group">
            <label>Upload Minutes Image (If Any) </label>
         ...
         <!-- <div class="form-group">
          ...
          <button type="submit" class="btn btn-primary mr-2">Edit Minutes</button>
