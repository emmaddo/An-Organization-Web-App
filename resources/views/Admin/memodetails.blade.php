  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <center>
       <img src="{{ url('../storage/front/images/memo/'.$viewmemo->image_name) }}" width="200px" alt="No Image for this Memo" />
            
       </center>
       <div class="form-group">
            <label for="exampleInputName1">Memo Date</label>
            <input type="text" name="title" value="{{$viewmemo->created_at}}" class="form-control" id="exampleInputName1" readonly>
          </div>
        <div class="form-group">
            <label for="exampleInputName1">Memo Topic</label>
            <input type="text" name="title" value="{{$viewmemo->topic}}" class="form-control" id="exampleInputName1" readonly>
          </div>
         ...
         <!-- <div class="form-group">
          ...
          <a href="{{url('Admin/EditMemo/'.$viewmemo->id)}}"  class="btn btn-primary mr-2">Edit Memo</a>
