...
@endif
  ...
  <div class="card-body">
    ...
    <form id="form1" method="POST" action="{{url('Admin/postbylocation')}}" enctype="multipart/form-data">
    @csrf  
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{number_format($due->sum,2)}}</td>
                   <td>
                    <a href="{{url('Admin/ByLocationDetails/'.$due->location)}}" class="btn btn-outline-primary">View Breakdown Report</a>
                  </td>
				       </tr>
                @endforeach
