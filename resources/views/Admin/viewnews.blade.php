...
@endif
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
  <div class="card-body">
    <h4 class="card-title">Added News</h4>
            ...
            <table id="order-listing" class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{url('Admin/NewsDetails/'.$post->id)}}" class="btn btn-outline-primary">View</a>
                  </td>
				   <td><a class="pe-2" href="{{url('Admin/EditNews/'.$post->id)}}"> <i class="mdi mdi-table-edit"></i></a> <a href="{{url('Admin/DeleteNews/'.$post->id)}}" onclick="return confirm('Are you sure you want to delete this News?')"> <i class="mdi mdi-delete"></i></a></td>
                </tr>
                @endforeach
