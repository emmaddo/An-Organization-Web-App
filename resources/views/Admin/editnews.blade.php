    ...
    <div class="card">
      <div class="card-body">
        ...
        @if(Session::get('success'))
          ...
          @endif<center>
       <img src="{{ url('../storage/front/images/news/'.$editnews->image_name) }}" width="200px" alt="News" />
            
       </center>

        <form class="forms-sample" method="POST" action="{{url('posteditnews/'.$editnews->id)}}" enctype="multipart/form-data">
        @csrf   
        <div class="form-group">
            <label for="exampleInputName1">News Title</label>
            <input type="text" name="title" value="{{$editnews->title}}" class="form-control" id="exampleInputName1" placeholder="Enter News Title">
          </div>
          <div class="form-group">
            <label for="exampleInputEmail3">News Intro</label>
            <input type="text" name="intro" value="{{$editnews->intro}}" class="form-control" id="exampleInputEmail3" placeholder="Enter News Intro">
          </div>
          
          
          <div class="form-group">
            <label for="exampleTextarea1">News Content</label>
            <textarea name="content" class="form-control" id="exampleTextarea1" rows="4">{{$editnews->content}}</textarea>
          </div>
         ...
         <!-- <div class="form-group">
          ...
          <button type="submit" class="btn btn-primary mr-2">Edit News</button>
