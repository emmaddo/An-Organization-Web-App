...
<head>
  <title>Location Detailed Report</title>
  <meta charset="utf-8">
...
@endif
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
  <div class="card-body">
    <h4 class="card-title">Location Detailed Report</h4>
    <div class="table-responsive">
    <form id="form1" method="POST" action="{{url('Admin/postbylocationdetails/'.$dname)}}" enctype="multipart/form-data">
    @csrf  
